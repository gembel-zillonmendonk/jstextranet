...
<div class="accordion">
    ...
    <?php if (strlen($params) > 0 && ! isset($_REQUEST['KODE_PERUBAHAN']) && isset($_REQUEST['KODE_KONTRAK']) && $_REQUEST['KODE_KONTRAK'] > 0): ?>
        ...
        <div></div>
        <h3 href="<?php echo site_url('/contract/view_grid_form/milestone.ep_ktr_jangka_kontrak' . $params) ?>">MILESTONE</h3>
        <div></div>
    ...
    <?php elseif (isset($_REQUEST['KODE_PERUBAHAN']) && $_REQUEST['KODE_PERUBAHAN'] > 0): ?>
        ...
        <h3 href="<?php echo site_url('/contract/ammend/view_grid_form/ammend.ep_ktr_perubahan_item' . $params) ?>">ITEM</h3>
        <div></div>
        <h3 href="<?php echo site_url('/contract/ammend/view_grid_form/ammend.ep_ktr_perubahan_jangka' . $params) ?>">MILESTONE</h3>
        <div></div>
