...
<div class="accordion">
    <h3 href="<?php echo site_url('/contract/form_view/contract.ep_ktr_kontrak' . $params) ?>">HEADER</h3>
    <div></div>
    <h3 href="<?php echo site_url('/contract/form_view/contract.ep_ktr_kontrak_jaminan' . $params) ?>">JAMINAN PELAKSANAAN</h3>
    <div></div>
    ...
    <?php if (strlen($params) > 0 && isset($_REQUEST['KODE_KONTRAK']) && $_REQUEST['KODE_KONTRAK'] > 0): ?>
        ...
        <div></div>
        <h3 href="<?php echo site_url('/contract/milestone/grid/milestone.ep_ktr_jangka_kontrak' . $params) ?>">MILESTONE</h3>
        <div></div>
        <h3 href="<?php echo site_url('/contract/grid/contract.ep_ktr_kontrak_dok' . $params) ?>">LAMPIRAN</h3>
        <div></div>
    <?php else: ?>
