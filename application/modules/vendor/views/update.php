<div class="tabs">
    ...
    <div id="tabs-10">
        <div class="accordion">
            <h3 href="<?php echo site_url('/vendor/grid_form/temp.ep_vendor_temp_principal') ?>">PRINCIPAL</h3>
            <div></div>
            <h3 href="<?php echo site_url('/vendor/grid_form/temp.ep_vendor_temp_subkontraktor') ?>">SUBKONTRAKTOR</h3>
            <div></div>
            <h3 href="<?php echo site_url('/vendor/grid_form/temp.ep_vendor_temp_afiliasi') ?>">PERUSAHAAN AFILIASI</h3>
            <div></div>
        </div>
    </div>
</div>
