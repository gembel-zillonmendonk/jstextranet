<div class="tabs">
    ...
    <div id="tabs-10">
        <div class="accordion">
            <h3 href="<?php echo site_url('/vendor/grid_form/ep_vendor_principal') ?>">PRINCIPAL</h3>
            <div></div>
            <h3 href="<?php echo site_url('/vendor/grid_form/ep_vendor_subkontraktor') ?>">SUBKONTRAKTOR</h3>
            <div></div>
            <h3 href="<?php echo site_url('/vendor/grid_form/ep_vendor_afiliasi') ?>">PERUSAHAAN AFILIASI</h3>
            <div></div>
        </div>
    </div>
</div>
