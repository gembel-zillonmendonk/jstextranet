...
class vw_ep_vendor_update extends MY_Model {
    ...
    public $sql_select = "( select x.*, y.*, '' as \"ACT\" from (
                                ...
                                where kode_wkf = 51 and tanggal_selesai is null
                            ) x
    ...
    function __construct() {
		...
		for(var i=0;i < ids.length;i++){
                    ...
                    var param = "referer_url=/vendor/monitor_update&kode_proses=" + data[\'KODE_PROSES\'] + data[\'URL\'];
                    var href = $site_url + "/vendor/compare?" + param;
                    
                    be = "<button onclick=\"javascript:window.location=\'" +href+ "\'\" type=\"button\" id=\"btnProses\" class=\"ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only\" role=\"button\" aria-disabled=\"false\"><span class=\"ui-button-text\">DETAIL</span></button>";
